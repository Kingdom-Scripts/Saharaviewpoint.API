...
namespace Saharaviewpoint.API.Migrations
{
    ...
    [Migration("20240731141030_Twenty-Seven")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Saharaviewpoint.Models.App.Document", b =>
                {
                    ...
                    b.Property<short>("VideoDuration")
            ...
            modelBuilder.Entity("Saharaviewpoint.Models.App.Login", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Saharaviewpoint.Models.App.ProjectLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProjectLogs", "dbo", t =>
                        {
                            t.HasCheckConstraint("CK_Project_Log", "[Type] IN ('Create', 'Update', 'Delete', 'Assignment', 'StatusChange', 'Approvals')");
                        });
                });

            modelBuilder.Entity("Saharaviewpoint.Models.App.ProjectTaskApproval", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProjectTaskApprovals", "dbo");
                });
            ...
            modelBuilder.Entity("Saharaviewpoint.Models.App.VideoAsset", b =>
                {
                    b.Property<int>("DocumentId")
                        .HasColumnType("int");

                    b.Property<string>("Hls")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Saharaviewpoint.Models.App.ProjectTaskApproval", b =>
                {
                    b.HasOne("Saharaviewpoint.Models.App.User", "FulfilledBy")
                        .WithMany()
                    ...
                    b.HasOne("Saharaviewpoint.Models.App.User", "Requester")
                        .WithMany()
            ...
            modelBuilder.Entity("Saharaviewpoint.Models.App.VideoAsset", b =>
                {
                    b.HasOne("Saharaviewpoint.Models.App.Document", "Document")
                        .WithOne("VideoAsset")
                        .HasForeignKey("Saharaviewpoint.Models.App.VideoAsset", "DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
